...
tables="k19_ods.ntc_ip_log_local k19_ods.ntc_http_log_local k19_ods.dm_conv_log_local k19_ods.ck_hour_increament_materialized_view_local k19_ods.ck_day_increament_materialized_view_local k19_ods.ck_slow_query_local k19_ods.ntc_ip_log_local_group_s_ip k19_ods.ntc_ip_log_local_group_d_ip k19_ods.ntc_ip_log_local_group_radius_account k19_ods.ntc_http_log_local_group_s_ip k19_ods.ntc_http_log_local_group_d_ip k19_ods.ntc_http_log_local_group_radius_account k19_ods.ntc_http_log_local_group_website k19_ods.dm_conv_log_local_group_client_ip k19_ods.dm_conv_log_local_group_server_ip"
function check(){
  for ((i=0;i<${#almaty_local_host_name[*]};i++))
  do
