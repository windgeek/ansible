...
ck_init_script_path=${BATHPATH}/sql/bigscreen

source ${BATHPATH}/users
#单节点创建本地表脚本名
local_table_sql=bigscreen.sql
...
tables="k19_ods.attack_conv_log_local k19_distribute.attack_conv_log k19_ods.bigscreen_dm_conv_log_local k19_distribute.bigscreen_dm_conv_log"
function check(){
  for ((i=0;i<${#almaty_local_host_name[*]};i++))
  do
