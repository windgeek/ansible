...
#单节点创建本地表脚本名
local_table_sql=ck_astana_monitor_local.sql
...
tables="k19_ods.oss_monitor_log_local  k19_ods.oss_ratelimiter_log_local  k19_ods.spark_exception_log_local k19_ods.spark_monitor_log_local k19_ods.yarn_monitor_log_local k19_distribute.oss_monitor_log  k19_distribute.oss_ratelimiter_log  k19_distribute.spark_exception_log k19_distribute.spark_monitor_log k19_distribute.yarn_monitor_log k19_ods.ck_slow_query_log_local"
function check(){
  for ((i=0;i<${#astana_local_host_name[*]};i++))
  do
