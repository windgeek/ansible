...
expect -c "spawn /usr/sbin/ambari-server setup
    ...
    expect {
          ...
          \"*Customize user account*\" {send \"root\r\";exp_continue}
          ...
          \"*Enable Ambari Server to download and install GPL*\" {send \"n\r\";exp_continue}
          ...
          \"*Database Password*\" {send \"{{ambari_mysql_password}}\r\";exp_continue}
          \"*Re-enter password*\" {send \"{{ambari_mysql_password}}\r\";exp_continue}
